...
(function () {
  const modalMarkup = `
    <div id="ils-modal" class="ils-modal">
      ...
      <h3>Not PeakD!</h3>
      <p>Do you want to go to PeakD now?</p>
      <button class="ils-button"
            onclick="(function() {window.location.href='https://peakd.com'+window.location.pathname+window.location.search})();">Go to PeakD.</button> 
    </div>`;
